...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <img alt="HMS" class="pull-left" src="<?php echo $base_url.'site/images/logonav.png'?>"><a class="navbar-brand titlehms" href="<?php echo $base_url.'sdashboard.php'?>">Students Residential Hall</a>
        </div>
        <!-- /.navbar-header -->
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li>
                        ...
                        <a href="<?php echo $base_url.'add_meal.php'?>"><i class="fa fa-money fa-fw"></i>Meal</a>
                    </li>
                    <li class="divider"></li>
