...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["btnLogin"])) {
        ...
        if ($msg == "true") {
            ...
            $loginId = $_POST["email"];
            $query = "select loginId,userGroupId,password,name,userId from users where loginId='$loginId'";
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-10 col-sm-12 col-xs-10">
                            <h4 class="pTitle" style="margin-left: 5px;">Students Residential Hall</h4>
                            </div>
                    </div>
