...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <img alt="HMS" class="pull-left" src="<?php echo $base_url.'site/images/logonav.png'?>"><a class="navbar-brand titlehms" href="<?php echo $base_url.'dashboard.php'?>">Students Residential Hall</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li><a href="<?php echo $base_url;?>ui/setting/adduser.php"><i class="fa fa-gear fa-fw"></i>Manage Admin</a>
                    </li>
                    <li class="divider"></li>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo $base_url.'ui/studentManage/seatalocation.php'?>">Seat Allocation</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
