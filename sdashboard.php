                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php
                                $sql = "SELECT * FROM stdpayment WHERE userId='$userIdf' AND transDate >= DATE_FORMAT(NOW(), '%Y-%m-01') AND isApprove='Yes'";
                                ...
                                $sql = "SELECT * FROM seataloc WHERE userId='$userIdf'";
                                $result = $db->getData($sql);
                                $row = mysql_fetch_array($result);
                                if($row['monthlyRent'] == NULL){
                                    $rent = 0;
                                }
                                else{
                                    $rent = $row['monthlyRent'];
                                }
                                $amount_ = $paid - ($rent + $GLOBALS['totals'][3]*$GLOBALS['totals'][2]); 
                             echo  abs($amount_ );?></div>
                            <div><?php
                                if($amount_ < 0){
                                    echo 'Due Amount';
                                }
                                else{
                                    echo 'Current Deposit';
                                }
