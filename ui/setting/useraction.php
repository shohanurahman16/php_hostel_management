...
function formRender($loginId, $user_name, $pass)
{ 
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Login Id" class="form-control" name="loginId" value="<?php echo $loginId;?>" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Name" class="form-control" name="name" value="<?php echo $user_name;?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
