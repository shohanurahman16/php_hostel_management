                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-info"></i> </span>
                                                    <input type="text" placeholder="National Id" class="form-control" name="nationalId" value="<?php echo $data[11];?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-info"></i> </span>
                                                    <input type="text" placeholder="Passport No" class="form-control" name="passportNo" value="<?php echo $data[12];?>">
                                                </div>
                                            </div>
