    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST["btnSave"])) {
            ...
            if ($msg = "true") {
                ...
                $result=$db->getData("SELECT * FROM attendence WHERE userId='".$userIdf."' and date='$date'");
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="isabs" name="isabs" required="">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="isLeave" name="isLeave" required="">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Additional Info" class="form-control" name="remark">
                                        </div>
                                    </div>
                                </div>
