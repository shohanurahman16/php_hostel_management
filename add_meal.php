        ...
        if (isset($_POST["btnSave"])) {
            ...
            if ($msg = "true") {
                ...
                if($result>=0)
                {
                    ...
                    //  $db->close();
                    echo '<script type="text/javascript"> alert("Meal Added Successfully.");window.location="sdashboard.php";</script>';
                }
                elseif(strpos($result,'Duplicate') !== false)
                {
                    echo '<script type="text/javascript"> alert("Meal Already Exits!");window.location="add_meal.php"; </script>';
                    getData();
                }
                else
                {
                    echo '<script type="text/javascript"> alert("' . $result . '");window.location="add_meal.php";</script>';
                }

            }
            else
            {
                echo '<script type="text/javascript"> alert("' . $msg . '");window.location="add_meal.php";</script>';
            }
        }
    }
    else
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="meal" action="add_meal.php"  accept-charset="utf-8" method="post" enctype="multipart/form-data">
